package com.gustz.dove.api.account.vo;
...
public class AccountVo extends AbstractBaseVo<String> {
    ...
    public String getAccountCodeLk() {
        return accountCodeLk;
    }

    public void setAccountCodeLk(String accountCodeLk) {
        this.accountCodeLk = accountCodeLk;
    }
