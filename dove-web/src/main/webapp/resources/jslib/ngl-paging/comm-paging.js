        ...
        [ function() {
          return {
            ...
            template : '<div class="page-list">'
                + '<ul class="paging" ng-show="conf.totalItems > 0">'
                ...
                + '/共<strong>{{ conf.totalItems }}</strong>条' + '</div>'
                + '<div class="no-items" ng-show="conf.totalItems <= 0">暂无有效数据！</div>' + '</div>',
            replace : true,
            scope : {
              conf : '='
            },
            link : function(scope, element, attrs) {
              ...
              if (!scope.conf.perPageOptions) {
                scope.conf.perPageOptions = [ 10, 20, 50, 100 ];
              }
              ...
              function getPagination() {
                ...
                // 定义状态
                var perPageOptionsStatus = false;
